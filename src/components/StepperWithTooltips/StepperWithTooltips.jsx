        ...
        <div className="flex items-center space-x-8">
            {steps.map((step, index) => (
                <div key={step.id} className="relative flex flex-col items-center">
                    ...
                    <div
                        className={`mx-[30px] flex h-[30px] w-[30px] cursor-pointer items-center justify-center rounded-full border-2 z-10 ${
                            hoveredStep === step.id
                    ...
                    >
                        ...
                        {hoveredStep === step.id && (
                            <div className="absolute -top-[80px] left-1/2 flex flex-col items-center">
                                <div
                                    className="relative z-10 flex h-[70px] w-[150px] -translate-x-1/2 transform items-center justify-center rounded bg-verdeTitulo p-2 text-center text-[12px] leading-[15px] text-blanco">
                                    {step.tooltip}
                                </div>
                                {/* Tooltip arrow */}
                                <div
                                    className="absolute -bottom-[15px] left-[0px] h-0 w-0 -translate-x-1/2 transform border-[8px] border-transparent border-t-verdeTitulo"></div>
                            </div>
                        )}
                    </div>
